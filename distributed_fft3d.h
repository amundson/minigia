...
public:
    ...
    std::vector<int> const& get_shape() const;
    std::vector<int> get_padded_shape_real() const;
    std::vector<int> get_padded_shape_complex() const;
...
typedef boost::shared_ptr<Distributed_fft3d>
    Distributed_fft3d_sptr; // syndoc:include
